...
<html>
    ...
    <body>
        <center>
            <fieldset style="border-color:blue; border-width: 3px;">
                <div style="width: 70%;">
                    ...
                    <div style="display: flex;">
                        ...
                        <div id="div3" style="width: 40%;">
                            <h1 style="color: red; background-color: pink; width: 85%; margin: 10px;border-radius: 10px;">Home</h1>
                            <h2 style="color: gold;">Welcome to SDFC Services</h2>
                            <section>
