    ...
    <fieldset>
        <div style="width: 70%;">
            ...
            <div style="display: flex; width: 100%;" >
                <div style="width: 20%;">
                    <h1 style="color: red; background-color: pink; width: 85%; margin: 10px;border-radius: 10px;">Service</h1>
                    <h4>Whatsapp</h4>
                ...
                <div style="width: 60%;">
                    <h1 style="color: red; background-color: pink; width: 85%; margin: 10px;border-radius: 10px;">Transfer</h1>
                    <form action="/amttransfer" method="POST">
                        <table>
                            <tr>
